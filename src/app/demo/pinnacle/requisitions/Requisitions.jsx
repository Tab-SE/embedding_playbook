    ...
    <div className="flex min-h-screen w-full flex-col">
      <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
        <Card className="shadow-xl">
          <CardHeader>
            <CardTitle>Requisitions &amp; Pipeline</CardTitle>
            <CardDescription>
              Open work orders, candidate funnel (submitted → qualified → shortlisted → interviewed → offered → accepted → started), SLA tracking, and aging requisitions.
            </CardDescription>
          </CardHeader>
