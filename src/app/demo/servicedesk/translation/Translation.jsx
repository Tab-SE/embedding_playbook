        ...
        <Card className='bg-slate-800 shadow-xl border-slate-700'>
            ...
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="flex items-center gap-2 text-white">
                  <Languages className="h-5 w-5 text-[hsl(199,99%,39%)]" />
              ...
              <div className="flex items-center gap-2">
                <label htmlFor="languageFilter" className="text-sm font-medium text-slate-300">
                  Language:
                </label>
                <select
                  id="languageFilter"
                  ...
                  className="px-4 py-2 border border-slate-600 rounded-lg bg-slate-700 text-slate-100 focus:outline-none focus:ring-2 focus:ring-[hsl(199,99%,39%)]"
                >
                  {languages.map((lang) => (
          ...
          <CardContent className="flex items-center justify-center p-0 xs:p-6 xs:pt-0">
            <TableauEmbed
              ...
              md:min-w-[1000px] md:min-h-[1000px]
