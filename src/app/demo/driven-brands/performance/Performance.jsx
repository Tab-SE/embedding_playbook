      ...
      <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
        <Card className="shadow-xl">
          <CardHeader>
            ...
            <CardDescription>
              Detailed breakdown of sales, vehicles serviced, and customer satisfaction by location &mdash; filtered to your authorized scope.
            </CardDescription>
          </CardHeader>
          <CardContent className="flex items-center justify-center p-0 sm:p-6 sm:pt-0">
            {/* Replace the src URL below with your Driven Brands location detail view URL */}
            <TableauEmbed
              id="locationDetailViz"
