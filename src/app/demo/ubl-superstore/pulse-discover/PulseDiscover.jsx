...
import { TableauEmbedUBL } from "@/components/TableauEmbed";
...
export const PulseDiscover = () => {
  // TODO: update path/workbook/view for UBL once available
  const dashboardUrl = `${domain}/t/${site}/views/PulseDiscoverPulseMCP/Dashboard1`;
