...
//           user.demo = credentials.demo;
//           const embed_session = new Session(user.name);
//           await embed_session.jwt(user.email, { /* options */ });
...
//   return NextResponse.json(await NextAuth(authOptions));
// }
...
// // This is the route handler for NextAuth.js in the App Router
// const handler = NextAuth(authOptions)
