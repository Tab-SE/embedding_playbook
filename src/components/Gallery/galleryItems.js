import { BriefcaseBusiness, ShoppingCart, HandCoins, HeartPulse } from 'lucide-react';
...
export const galleryItems = [
  {
    ...
    description:
      'The default demo showcasing embedded AI and analytics via dashboards, metrics, charts and natural language assistants',
  ...
  },
  {
    ...
    description:
      'A software solution that helps businesses streamline the quoting process for customizable products and services',
  ...
  },
  {
    ...
    description:
      'A wealth management app that empowers users to make informed financial decisions, allowing them to track net worth and analyze portfolio performance',
  ...
  },
  {
    ...
    description:
      'A healthcare payer portal app that helps users make data-driven decisions related to claims, costs, utilization, and quality measures to improve patient outcomes',
