import { Home, Package, ShoppingCart, Users2, BrainCircuit } from 'lucide-react';

import users from './users';

export const settings = {
  app_id: 'superstore',
  app_name: 'eBikes Analytics',
  app_logo: '/img/themes/superstore/superstore.png',
  base_path: '',
  auth_hero:
    'https://images.unsplash.com/photo-1590859808308-3d2d9c515b1a?q=80&w=2948&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  ai_chat: true,
