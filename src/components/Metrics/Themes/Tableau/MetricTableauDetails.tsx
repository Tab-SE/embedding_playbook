...
import { parseInsights, applyVizFormatting } from '../../../../utils';
  ...
  if (isSuccess && insights && insights.length) {
    return (
      <div className="" key={metric.specification_id}>
        <div
          className="bg-white border border-blue-100 rounded-xl shadow-md p-8 mb-4 hover:shadow-lg cursor-pointer  flex flex-col h-full"
          style={Object.assign({}, contextData.options.cardText, {
            backgroundColor: contextData.options.cardBackgroundColor,
          })}
        >
          {/* Card Header */}
          <div className="mb-4" style={contextData.options.cardTitleText}>
            ...
            <div style={contextData.options.cardText}>
              {`${metric.namePeriod} ${
            ...
            <div className="flex justify-center items-center">
              <div className="flex flex-col items-center">
                <span
                  className="font-normal mr-3 leading-[3rem]"
                ...
                <span
                  ...
                  style={{
                    fontFamily: contextData.options.cardBANText.fontFamily,
                    color: contextData.options.cardBANText.color,
                  }}
                >
                  {stats.units}&nbsp;
                </span>
              ...
              {contextData.timeComparisonMode !== 'text' && (
                <div
                  style={{
                    ...
                    fontFamily: contextData.options.cardText.fontFamily,
                    fontSize: contextData.options.cardText.fontSize,
                  }}
                >
                  <div className="">{stats?.comparisons?.[0].comparison}</div>
              ...
              {contextData.timeComparisonMode === 'both' &&
                ...
                (stats?.comparisons[1].is_nan ? (
                  ...
                  >
                    <div className="">{stats?.comparisons?.[1].comparison}</div>
                    ...
                    <div className="mb-4">
                      {Object.keys(insights[0].viz).length > 0 && (
                        <VegaLiteViz
                          height="140"
                          width="100%"
                          spec={applyVizFormatting(insights[0]?.viz, contextData)}
                          testId={undefined}
                        />
                      )}
                    </div>
                    <article style={contextData.options.cardText}>
