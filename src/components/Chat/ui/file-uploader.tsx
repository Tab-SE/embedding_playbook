...
import { IconLoader, IconPaperclip } from '@tabler/icons-react';
...
export default function FileUploader({
  ...
  return (
    <div className="self-stretch">
      ...
      >
        {uploading ? (
          <IconLoader stroke={2} className="h-4 w-4 icon-rotate" />
        ) : (
          <IconPaperclip stroke={2} className="w-4 h-4 -rotate-45" />
        )}
      </label>
    </div>
  );
