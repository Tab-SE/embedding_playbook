...
import { Popover, PopoverContent, PopoverTrigger, PopoverAnchor } from 'components/ui';
  ...
  return (
    <PopoverAnchor asChild>
      <Avatar className="fixed bottom-6 right-6 z-50 w-12 h-12 shadow-xl bg-white dark:bg-stone-900 border border-double border-4 border-stone-300">
        ...
        <AvatarImage src="/img/other/bot.png" alt="AI Demo" />
      ...
      <div className="absolute top-[-9999px] left-[-9999px] bg-transparent">
        {showChat && (
          <Popover modal>
            ...
            <PopoverContent className="w-[51vw] mb-9" side="left" align="start" sideOffset={33}>
              <Chat />
            </PopoverContent>
          </Popover>
        )}
