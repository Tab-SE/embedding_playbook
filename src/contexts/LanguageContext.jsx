...
// Language translations (module scope so useLanguage can fall back to them)
const translations = {
  en: {
...
export const useLanguage = () => {
  ...
  // No hard dependency on LanguageProvider: fall back to English defaults
  // so components render fine even when no provider is mounted.
  if (!context) {
    return {
      language: 'en',
      setLanguage: () => {},
