...
export const ContractJobManagement = () => {
  return (
    <TabsContent value="contract" className="space-y-4">
      <Card style={{backgroundColor: "white"}}>
        ...
        <CardContent className="flex justify-center items-center">
          <TableauEmbed
            src='https://prod-useast-b.online.tableau.com/#/site/embeddingplaybook/views/Projectpipelinereport/Projectpipelinereport?:iid=1'
            hideTabs={true}
            toolbar='hidden'
            className='
